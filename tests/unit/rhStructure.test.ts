...
describe('RH (Onda 2) — estrutura e scaffold', () => {
    it('client expõe os endpoints reais de RH', () => {
        ...
        expect(api).toContain("const FERIAS = '/api/rh/ausencias/ferias'");
        expect(api).toContain("const AFASTAMENTOS = '/api/rh/ausencias/afastamentos'");
        ...
        expect(api).toContain('${FERIAS}/${id}/${acao}');
