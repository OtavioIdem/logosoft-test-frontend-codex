...
export const routePermissionRules: RoutePermissionRule[] = [
    ...
    { pattern: /^\/fiscal\/notas(?:\/.*)?$/, anyOf: ['FISCAL_CONSULTAR', 'FISCAL_EXPORTAR', 'FISCAL_GERENCIAR', 'FISCAL_EMITIR', 'FISCAL_CANCELAR', 'FISCAL_CARTA_CORRECAO', 'FISCAL_REPROCESSAR'], description: 'Notas fiscais' },
