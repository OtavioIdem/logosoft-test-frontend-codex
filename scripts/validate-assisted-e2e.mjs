...
if (existsSync(join(root, 'package.json'))) {
    ...
    if (packageJson.logosoftVersion !== '1.11.0a8b38.c1') failures.push('package.json: logosoftVersion deve ser 1.11.0a8b38.c1');
...
if (existsSync(join(root, 'tests/evidence/integrated-e2e.assisted-evidence.example.json'))) {
    ...
    if (evidence.version !== '1.11.0a8b38.c1') failures.push('tests/evidence/integrated-e2e.assisted-evidence.example.json: version deve ser 1.11.0a8b38.c1');
