...
export const PERMISSOES_CATALOGO: Record<PermissionCode, PermissaoCatalogoItem> = {
    ...
    SEGURANCA_USUARIOS_INATIVAR: { grupo: 'Segurança', label: 'Usuários · Inativar' },
    SEGURANCA_USUARIOS_RESETAR_SENHA: { grupo: 'Segurança', label: 'Usuários · Resetar senha' },
    SEGURANCA_PERMISSOES_CONSULTAR: { grupo: 'Segurança', label: 'Acesso efetivo · Consultar' },
    SEGURANCA_PERMISSOES_GERENCIAR: { grupo: 'Segurança', label: 'Cargos de acesso · Gerenciar' },
    SEGURANCA_GRUPOS_ACESSO_CONSULTAR: { grupo: 'Segurança', label: 'Grupos de acesso · Consultar' },
    SEGURANCA_GRUPOS_ACESSO_GERENCIAR: { grupo: 'Segurança', label: 'Grupos de acesso · Gerenciar' },
    SEGURANCA_SESSOES_GERENCIAR: { grupo: 'Segurança', label: 'Sessões · Gerenciar' },
    SEGURANCA_PARAMETROS_CONSULTAR: { grupo: 'Segurança', label: 'Parâmetros · Consultar' },
    SEGURANCA_PARAMETROS_GERENCIAR: { grupo: 'Segurança', label: 'Parâmetros · Gerenciar' },
    // Administração
    ADMINISTRACAO_CONSULTAR: { grupo: 'Administração', label: 'Consultar' },
    ADMINISTRACAO_GERENCIAR: { grupo: 'Administração', label: 'Gerenciar' },
    // Infraestrutura
    INFRAESTRUTURA_CONSULTAR: { grupo: 'Infraestrutura', label: 'Consultar' },
    INFRAESTRUTURA_BACKUP_CONSULTAR: { grupo: 'Infraestrutura', label: 'Backup · Consultar' },
    // Auditoria / Atividades / Relatórios
    AUDITORIA_CONSULTAR: { grupo: 'Auditoria', label: 'Consultar' },
    AUDITORIA_OPERACIONAL_CONSULTAR: { grupo: 'Auditoria', label: 'Operacional · Consultar' },
    ATIVIDADES_CONSULTAR: { grupo: 'Atividades', label: 'Consultar' },
    ATIVIDADES_CRIAR: { grupo: 'Atividades', label: 'Criar' },
    ATIVIDADES_ATUALIZAR: { grupo: 'Atividades', label: 'Atualizar' },
    ATIVIDADES_CANCELAR: { grupo: 'Atividades', label: 'Cancelar' },
    ATIVIDADES_COMENTAR: { grupo: 'Atividades', label: 'Comentar' },
    ATIVIDADES_ATRIBUIR: { grupo: 'Atividades', label: 'Atribuir' },
    RELATORIOS_OPERACIONAIS_CONSULTAR: { grupo: 'Relatórios', label: 'Operacionais · Consultar' },
    RELATORIOS_VENDAS_CONSULTAR: { grupo: 'Relatórios', label: 'Vendas · Consultar' },
    RELATORIOS_COMPRAS_CONSULTAR: { grupo: 'Relatórios', label: 'Compras · Consultar' },
    RELATORIOS_FINANCEIRO_CONSULTAR: { grupo: 'Relatórios', label: 'Financeiro · Consultar' },
    RELATORIOS_ESTOQUE_CONSULTAR: { grupo: 'Relatórios', label: 'Estoque · Consultar' },
    RELATORIOS_FISCAL_CONSULTAR: { grupo: 'Relatórios', label: 'Fiscal · Consultar' },
    RELATORIOS_PRODUCAO_CONSULTAR: { grupo: 'Relatórios', label: 'Produção · Consultar' },
    RELATORIOS_DASHBOARD_CONSULTAR: { grupo: 'Relatórios', label: 'Dashboard · Consultar' },
    ...
    PESSOAS_BLOQUEAR: { grupo: 'Pessoas', label: 'Bloquear' },
    PESSOAS_DADOS_FISCAIS_GERENCIAR: { grupo: 'Pessoas', label: 'Dados fiscais · Gerenciar' },
    ...
    TRANSPORTADORAS_CONSULTAR: { grupo: 'Transportadoras', label: 'Consultar' },
    TRANSPORTADORAS_GERENCIAR: { grupo: 'Transportadoras', label: 'Gerenciar' },
    ...
    FISCAL_REPROCESSAR: { grupo: 'Fiscal', label: 'Reprocessar' },
    ...
    FISCAL_CADASTROS_GERENCIAR: { grupo: 'Fiscal', label: 'Cadastros fiscais · Gerenciar' },
    FISCAL_SERIES_CONSULTAR: { grupo: 'Fiscal', label: 'Séries · Consultar' },
    FISCAL_SERIES_GERENCIAR: { grupo: 'Fiscal', label: 'Séries · Gerenciar' },
    FISCAL_MODELOS_CONSULTAR: { grupo: 'Fiscal', label: 'Modelos de documento · Consultar' },
    // Notificações / Anexos
    ...
    // Integrações
    INTEGRACOES_CONSULTAR: { grupo: 'Integrações', label: 'Consultar' },
    INTEGRACOES_GERENCIAR: { grupo: 'Integrações', label: 'Gerenciar' },
    INTEGRACOES_REPROCESSAR: { grupo: 'Integrações', label: 'Reprocessar' },
    ...
    FATURAMENTO_RETOMAR_REVERSAO: { grupo: 'Faturamento', label: 'Retomar reversão' },
    ...
    PORTARIA_PREAUTORIZAR: { grupo: 'Portaria', label: 'Pré-autorizar' },
