...
export default function Page() {
    return (
        <ModulePlaceholderPage
            ...
            nextSteps={['Confirmar contrato de grupos de acesso no backend.', 'Implementar API client específico usando apenas endpoints reais do backend.', 'Aplicar testes de permissão, listagem e salvamento.']}
        />
    );
}
